                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="paypal" value="" placeholder="{{ Translate('Paypal') }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label for="bank_info" class="col-md-3 col-from-label">{{ Translate('Bank Information') }} - Bank</label>
                            <div class="col-md-8">
                                <input type="text" class="form-control" name="bank_info" value="" placeholder="{{ Translate('Bank Information') }}">
                            </div>
                        </div>
                    </div>
                </div>
