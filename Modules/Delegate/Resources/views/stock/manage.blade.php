...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h1 class="mb-0 h6"><a href="{{ route('stock.index') }}" class="text-dark"><i class="las la-arrow-left"></i> {{ translate('Back') }}</a></h1>
</div>
<div class="">
    {{-- <form class="form form-horizontal mar-top" action="{{route('stock.store')}}" method="POST" id="choice_form"> --}}
        <div class="row gutters-5">
            <div class="col-lg-8">
                ...
                <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{ translate('Products + Stock') }}</h5>
                    </div>
                    <div class="card-body">
                         <table class="table aiz-table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <strong class="btn-soft-info btn-circle btn-sm" style="transition: all 0.3s ease;">{{ $item->stock }}</strong>
                                    </td>
                                    <td class="text-right">
            ...
            <div class="col-lg-4">
                 <div class="card">
                    <div class="card-header">
                        <h5 class="mb-0 h6">{{translate('Add Product Stock')}}</h5>
                    </div>
                    <div class="card-body">
                            ...
                            <div class="form-group mb-3">
                                <div class="btn-toolbar float-right" role="toolbar" aria-label="Toolbar with button groups">
                                    <div class="btn-group" role="group" aria-label="Second group">
                                        <button type="submit" name="button" value="create" class="btn btn-info action-btn">{{ translate('Add') }}</button>
                                    </div>
                                </div>
                            </div>
                        </form>
