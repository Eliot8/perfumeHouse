{{-- <div id="edit-modal{{$zone->id}}" class="modal fade" >
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <form class="form form-horizontal mar-top" action="{{ route('zones.update', $zone->id) }}" method="POST">
...
<div class="aiz-titlebar text-left mt-2 mb-3">
    <h5 class="mb-0 h6">@lang('delegate::delivery.edit_zone')</h5>
</div>
<div class="">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="form-group row">
                            <label class="col-md-3 col-from-label">{{ translate('Name') }} <span class="text-danger">*</span></label>
                            <div class="col-md-8">
                                <input type="text" class="form-control @error('name') is-invalid @enderror" name="name" value="{{ $zone->name }}" placeholder="@lang('delegate::delivery.zone_name')" required>
                                @error('name')
