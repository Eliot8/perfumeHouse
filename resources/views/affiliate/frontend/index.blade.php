                    ...
                    <div class="row gutters-10">
                        ...
                        <div class="col-md-3 mx-auto mb-3" >
                          <div class="bg-grad-1 text-white rounded-lg overflow-hidden">
                            ...
                            <div class="px-3 pt-3 pb-3">
                                <div class="h4 fw-700 text-center">{{ single_price(Auth::user()->affiliate_user->balance_pending) }}</div>
                                <div class="opacity-50 text-center">{{ translate('Affiliate Balance Pending') }}</div>
                            </div>
                          </div>
                        </div>
                        <div class="col-md-3 mx-auto mb-3" >
                ...
                <form class="" action="{{ route('affiliate.withdraw_request.store') }}" method="post">
                    ...
                    <div class="modal-body gry-bg px-3 pt-3">
                        <div class="row">
                            ...
                            <div class="col-md-9">
                                <input type="number" class="form-control mb-3" name="amount" min="1"  placeholder="{{ translate('Amount')}}" required>
                            </div>
                        </div>
