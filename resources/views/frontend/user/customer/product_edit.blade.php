    ...
    <form class="" action="{{ route('customer_products.update', $product->id) }}" method="POST"
        ...
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="form-group row">
                    <label class="col-md-2 col-from-label">{{ translate('Product Unit') }} <span class="text-danger">*
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-10">
                        <select class="form-control selectpicker" data-placeholder="{{ translate('Select a condition') }}"
                            ...
                            <option value="used" @if ($product->conditon == 'used') selected @endif>{{ translate('Used') }}
                            </option>
                        </select>
                    </div>
                </div>
